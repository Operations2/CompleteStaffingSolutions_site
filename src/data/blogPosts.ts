...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "A staffing firm worth working with [CSS - Recruiting](/our-recruiting-process) will ask those questions and tell you which structure actually makes sense, rather than defaulting to the higher-margin option.",
